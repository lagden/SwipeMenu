(function(global, factory) {
	...
	var EventEmitter = __commonjs(function(module, exports, global) {
		/*!
		...
		;(function() {
			...
			proto.addListener = function addListener(evt, listener) {
				...
				var listenerIsWrapped = (typeof listener === 'undefined' ? 'undefined' : babelHelpers.typeof(listener)) === 'object';
				var key;
			...
			proto.manipulateListeners = function manipulateListeners(remove, evt, listeners) {
				...
				if ((typeof evt === 'undefined' ? 'undefined' : babelHelpers.typeof(evt)) === 'object' && !(evt instanceof RegExp)) {
					for (i in evt) {
			...
			proto.removeEvent = function removeEvent(evt) {
				var type = typeof evt === 'undefined' ? 'undefined' : babelHelpers.typeof(evt);
				var events = this._getEvents();
				var key;
	...
	var EventEmitter$1 = EventEmitter && (typeof EventEmitter === 'undefined' ? 'undefined' : babelHelpers.typeof(EventEmitter)) === 'object' && 'default' in EventEmitter ? EventEmitter['default'] : EventEmitter;
	...
	var SwipeMenu = function() {
		...
		babelHelpers.createClass(SwipeMenu, [{
			...
			value: function ontouchstart(event) {
				var menuIsOpen = this.menu.classList.contains('menu--open');
				this.check = false;
